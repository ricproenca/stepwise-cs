#!/usr/bin/env bash
# Runs the 12-point completion checklist for a 9618 topic.
# Usage: bash .claude/skills/references/validation-checks.sh <slug>
...
# 4. Pseudocode uses Cambridge conventions (heuristic)
...
# 7. Past-paper cross-check recorded in meta.md
...
# 8. Model-answer mark-scheme alignment (manual)
...
# 9. Questions: ≥ 10, Difficulty tags, ≥ 1 past-paper
...
# 10. Glossary ≥ 10 terms, definitions ≤ 2 sentences
...
# 12. HTML pages (skip if frontend-builder has not run)
hdr "12. HTML pages"
